...
The goal of this project is to create a 3D voxel engine tech demo reminiscent of Minecraft, written in Python, that runs on EndeavorOS (Arch Linux), Windows 11, and macOS. Features include infinite world generation, procedural terrain with mountain valleys, cave systems, ore generation, and water rendering.
